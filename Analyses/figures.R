...
#-------------------------------------------------#
pdf(height =  7.25000, width = 16.22222, file = "./output/figures/figure1.2_10.01.17.pdf")
    par(mfrow=c(1, 3), mar=c(4,8,2.5,2.5))
	    #A)
	    ...
	    mtext(side = 2, text = "(a)", adj = 2.5, las = 1, padj = -13, font = 3, cex = 2)
		...
		mtext(side = 2, "(b)", adj = 4, las = 1, padj = -13, font = 3, cex = 2)
